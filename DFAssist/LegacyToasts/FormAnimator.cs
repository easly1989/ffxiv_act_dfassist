...
namespace DFAssist.LegacyToasts
{
    public sealed class FormAnimator
    {
        ...
        private void Form_Load(object sender, EventArgs e)
        {
            ...
            LegacyToast.AnimateWindow(Form.Handle, Duration, (int)((AnimationMethod)131072 | Method | (AnimationMethod)Direction));
        }
        ...
        private void Form_VisibleChanged(object sender, EventArgs e)
        {
            ...
            LegacyToast.AnimateWindow(Form.Handle, Duration, !Form.Visible ? num | 65536 : num | 131072);
        }
        ...
        private void Form_Closing(object sender, CancelEventArgs e)
        {
            ...
            LegacyToast.AnimateWindow(Form.Handle, Duration,(int)((AnimationMethod)65536 | Method | (AnimationMethod)Direction));
        }
    }
}